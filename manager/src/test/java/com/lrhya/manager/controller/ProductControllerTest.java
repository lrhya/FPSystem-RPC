package com.lrhya.manager.controller;
...
import com.lrhya.util.RestUtil;
...
public class ProductControllerTest {
    ...
    public static void addProduct() {
        Product p1 = new Product("A001", "金融产品1号", ProductStatus.AUDITING.name(),
                BigDecimal.valueOf(10), BigDecimal.valueOf(1), BigDecimal.valueOf(3.56));
        normals.add(p1);
        Product p2 = new Product("A002", "金融产品2号", ProductStatus.AUDITING.name(),
                BigDecimal.valueOf(100), BigDecimal.valueOf(5), BigDecimal.valueOf(3.68));
        normals.add(p2);
